...
description: The four properties Ursula keeps that other servers force you to trade, and the per-entity timeline model that makes the pattern simple to build on.
---
